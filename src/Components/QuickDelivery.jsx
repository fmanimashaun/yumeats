    ...
    <div className="max-w-[1240px] w-full mx-auto grid md:grid-cols-2 md:items-center">
      ...
      <div className="flex flex-col justify-center order-0 md:order-1">
        ...
        <p className="">
          ...
          ex deserunt fuga? Lorem ipsum dolor sit amet consectetur adipisicing
          elit. Voluptatum molestiae delectus culpa hic assumenda, voluptate
          reprehenderit dolore autem cum ullam sed odit perspiciatis. Doloribus
          quos velit, eveniet ex deserunt fuga? Lorem ipsum dolor sit amet
          consectetur adipisicing elit. Voluptatum molestiae delectus culpa hic
          assumenda, voluptate reprehenderit dolore autem cum ullam sed odit
          perspiciatis. Doloribus quos velit, eveniet ex deserunt fuga?
        </p>
        <button
          type="button"
          className="bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 md:mx-0 py-3"
        >
          Get Started
        </button>
      </div>
